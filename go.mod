...
require (
	...
	github.com/projectcalico/libcalico-go v1.7.2-0.20210820170212-87622d0e02fc
...
replace github.com/projectcalico/libcalico-go => github.com/caseydavenport/libcalico-go v0.0.0-20210830234933-05d78e2b6318
